...
import flextimer.turnFlow.strategy.StraightTurnPassingStrategy;
import flextimer.turnFlow.util.TimerTurn;
import org.junit.jupiter.api.*;

import static org.junit.jupiter.api.Assertions.*;

public class StraightTurnPassingStrategyTest {
    private static final int PHASES_COUNT = 3;

    private static StraightTurnPassingStrategy strategy;
    ...
    public static void setUpPlayers() throws Exception {
        strategy = new StraightTurnPassingStrategy();
